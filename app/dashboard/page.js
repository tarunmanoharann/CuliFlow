    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="w-64 bg-white shadow-lg fixed h-full overflow-y-auto">
        ...
        <nav className="mt-5 px-2">
          <Link href="#" className="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-gray-900 bg-gray-100 focus:outline-none focus:bg-gray-200 transition-all duration-300 ease-in-out hover:bg-gray-200">
            <LayoutDashboard className="mr-4 h-6 w-6" />
            Dashboard
          </Link>
          <Link href="#" className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-100 transition-all duration-300 ease-in-out">
